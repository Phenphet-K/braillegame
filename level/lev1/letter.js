...
document.addEventListener('DOMContentLoaded', function () {
  ...
  function endGame() {
    ...
    setTimeout(function () {
      resetGame();
      startTimer();
      window.location.href = "https://krootoi.rf.gd/braillegame/letter.html";
    }, 5000);
  }
...
function updateScore(nb = 0) {
  ...
  if (score >= 26) {
    ...
    if (userConfirmed) {
      ...
      window.location.href = "https://krootoi.rf.gd/braiilegame/letter.html"; // เปลี่ยน "หน้าถัดไป.html" เป็น URL หน้าถัดไปที่คุณต้องการ
    }
  }
}
