...
function updateScore(nb) {
  ...
  if (score > 10) {
    // แสดงกล่องแจ้งเตือน
    const userConfirmed = window.confirm("ยินดีด้วยคุณผ่านด่านแล้ว คุณต้องด่านถัดไปหรือไม่?");
    
    if (userConfirmed) {
      // ทำการเปลี่ยนหน้าหรือทำการนำผู้เล่นไปยังหน้าถัดไป
      window.location.href = "https://krootoi.rf.gd/braillegame/level/lev1/letter.html"; // เปลี่ยน "หน้าถัดไป.html" เป็น URL หน้าถัดไปที่คุณต้องการ
    }
  }
}
